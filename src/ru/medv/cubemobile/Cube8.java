...
public class Cube8
{
	...
	Cube8()
	{
		...
		gran[0]=new Cube8GranMIDlet(0,1,2,3, Color.BLUE);   //н гр.
		gran[1]=new Cube8GranMIDlet(4,5,1,0, Color.CYAN);   //up гр.
		gran[2]=new Cube8GranMIDlet(5,6,2,1, Color.GREEN);  //lt гр.
		gran[3]=new Cube8GranMIDlet(6,7,3,2, Color.MAGENTA);//dn гр.
		gran[4]=new Cube8GranMIDlet(7,4,0,3, Color.RED);    //rt гр.
		gran[5]=new Cube8GranMIDlet(7,6,5,4, Color.YELLOW); //в гр.
	}
